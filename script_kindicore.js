...
function initNeuralNetwork() {
    ...
    function draw() {
        ...
        nodes.forEach((node, idx) => {
            ...
            node.targetGlow = isActive ? 35 : 12; // Higher glow for active

            // Lerp current values to targets for smoothness
            ...
            if (node.iconPath) {
                ...
                const scale = (node.currentSize / 28) * 0.7; // Approx scale
    ...
    function setActive(index) {
        ...
        cards.forEach((card, idx) => {
            if (idx === index) {
                ...
                card.style.opacity = "0.7"; // Dim others slightly
            }
        });
    }
        ...
        fetch('contac.php', {
            ...
            .then(data => {
                if (data.type === 'success') {
                    messageDiv.innerHTML = `<div class="form-alert form-alert-success">
                    <strong>¡Enviado!</strong> ${data.message}
                </div>`;
                    form.reset();
                } else {
                    messageDiv.innerHTML = `<div class="form-alert form-alert-error">
            ...
            .catch(error => {
                ...
                messageDiv.innerHTML = `<div class="form-alert form-alert-error">
                <strong>Error de conexión.</strong> Por favor intenta nuevamente.
            </div>`;
            })
            .finally(() => {
                ...
                if (messageDiv.querySelector('.form-alert-success')) {
                    setTimeout(() => {
